 ...
 * 
 *   This file uses OpenMP to optimise the activation function and
 *   backpropagation by optimising the computation done within a single layer
 *   (but not yet with swapped loops)
**/
